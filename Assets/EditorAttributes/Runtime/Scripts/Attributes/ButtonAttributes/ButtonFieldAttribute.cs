...
namespace EditorAttributes
{
    ...
    public class ButtonFieldAttribute : PropertyAttribute, IRepetableButton
    {
        ...
        /// <param name="buttonLabel">The label displayed on the button</param>
        /// <param name="buttonHeight">The height of the button in pixels</param>
        public ButtonFieldAttribute(string functionName, bool isRepetable, long pressDelay = 60, long repetitionInterval = 100, string buttonLabel = "", float buttonHeight = 18f) : this(functionName, buttonLabel, buttonHeight)
        {
